...
yearago = (Sys.Date() - 365) %>% as.character %>% str_replace(" ", "")
twoyearsago = (Sys.Date() - 365 * 2) %>% as.character %>% str_replace(" ", "")
