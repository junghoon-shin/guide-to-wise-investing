...
description: "Investment data book containing business financials, industry and market environment, and global economy"
---
...
thishour = now(tzone = "Europe/London") %>% strftime(format = "%H") %>% as.numeric
...
index_plot(index_2yr %>% filter(name == "Tbondfutures"), "U.S. T-bond futures", from = as_date(twoyearsago), ribbon = T)
```
...
```{r, fig.height = 8/2.5, fig.cap = "U.S. Treasury Bond Futures"}
index_plot(index_30yr %>% filter(name == "Tbondfutures"), "U.S. T-bond futures", from = as_date(thirtyyearsago) - 30)
```
...
```{r}
daily = c("KOSPI", "KOSDAQ", "Wilshire5000", "WilshireREIT", "Gold", "WTI", "Tbondfutures", "AAA", "USDKRW")
...
relabel = function(symbol) c(KOSPI = "KOSPI",
                             ...
                             Copper = "Copper price",
                             WTI = "Crude oil price",
                             Tbondfutures = "U.S. T-bond futures",
...
## Market capitalization^[Data are from [World Bank](https://data.worldbank.org/indicator/CM.MKT.LCAP.CD?view=chart) and [Wikipedia](https://en.wikipedia.org/wiki/List_of_stock_exchanges). Most recent 3 years for which top 3 countries\' data are available are shown.]
