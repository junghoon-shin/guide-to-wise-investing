...
```{r}
scenario = tibble(Variable = c("Initial investment", "Monthly investment", "Investment increment per year", "Target profit", "Inflation"),
                  `Assumption (thousand USD)` = c("20", "5", "5%", "20%", "2%"))

scenario %>% 
  kbl(escape = F, col.names = colnames(.), caption = "Assumed investment scenario") %>%
