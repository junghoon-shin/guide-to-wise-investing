...
```{r, fig.width = 7, fig.height = (notNA_per + 3)/4, fig.cap = "Current, trailing, and forward PE ratio by industry sector"}
industry_per %>%
...
```{r, fig.width = 7, fig.height = (nrow(industry %>% filter(!is.na(`Expected growth - next 5 years`))) + 2)/4, fig.cap = "Expected growth rate for the next 5 years by industry sector"}
industry %>%
...
```{r, fig.width = 7, fig.height = (nrow(industry2 %>% filter(!is.na(`Return on Capital`))) + 2)/4, fig.cap = "Expected growth rate for the next 5 years by industry sector"}
industry2 %>%
