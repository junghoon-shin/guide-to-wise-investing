...
(ref:adjusted-closing-price) [Adjusted stock prices](https://www.investopedia.com/terms/a/adjusted_closing_price.asp) over the last 2 years. The blue shade at the bottom of each panel indicates trading volume per day (smoothed for visualization).
