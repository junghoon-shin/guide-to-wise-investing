...
relation_plot = function(.data, x, y, xlab = NULL, ylab = NULL, xlabels = waiver(), ylabels = waiver(), panelwidth) {
  ...
  .data %<>% mutate(fontsize = rescale(log10(Marketcap_USD/1e9), c(1, 6)),
  ...
  get_expansion = function(.data, panelwidth) {
    for (left_expansion in 1:20/20) {
      for (right_expansion in 1:20/20) {
...
```{r, fig.width = 7, fig.height = 9 * 7, fig.cap = "Scatterplot of key statistics"}
