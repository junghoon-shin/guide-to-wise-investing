...
index_plot(Buffett, "Buffett indicator", as_date(fiftyyearsago) - 30)
```
...
index_plot(Shiller, "Shiller P/E ratio", as_date(fiftyyearsago) - 30)
```

(ref:sp500per) [S&P 500 PE Ratio, based on trailing twelve month "as reported" earnings](https://www.multpl.com/s-p-500-pe-ratio)

```{r, fig.height = 8/2.5, fig.cap = "(ref:sp500per)"}
index_plot(SP500PER, "S&P 500 P/E ratio", as_date(fiftyyearsago) - 30)
```
