...
```{r, fig.width = 7, fig.height = 5 * length(unique(combined$Year)), fig.cap = str_c("Market capitalization relative to GDP across ", length(unique(combined$`Country Name`)), " major countries")}
